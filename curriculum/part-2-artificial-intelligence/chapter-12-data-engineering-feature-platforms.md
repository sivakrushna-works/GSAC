...
- **Backfilled and mutated fields** — operational teams update records in place ("complaint resolution date" filled in days later — Meridian's V2 leak in [2.9](chapter-09-classical-ml-system-design.md)). Snapshot or CDC history is the only defense; a table that overwrites its past cannot train honest models.
