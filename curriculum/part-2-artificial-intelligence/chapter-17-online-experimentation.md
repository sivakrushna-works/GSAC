...
1. **Comparing to last period** — seasonality, mix shift, and regression to the mean masquerade as impact (Varuna's attempt 1). The counterfactual must be *concurrent and randomized*, or explicitly quasi-experimental with stated assumptions.
