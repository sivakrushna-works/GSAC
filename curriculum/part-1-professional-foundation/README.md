...
The mindset shift from *building what you're told* to *deciding what gets built*. Everything in Parts 2–7 is technique; this part is the judgment that makes technique valuable. Skimmable if you already hold an architect role — but do the exercises in 1.4 and 1.5 regardless.
...
- A written trade-off analysis for a real decision at your job (chapter 1.4 exercise)
- A one-page architecture brief + ADR for a system you know (chapter 1.5 exercise)

**Next:** [Part 2 — Artificial Intelligence](../part-2-artificial-intelligence/)
