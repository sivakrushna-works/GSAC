...
- The [GSAC case studies](../../case-studies/README.md) — the pattern language's known uses; the 50 case studies as pattern combinations, cross-linked to the catalog (7.2–7.10).
