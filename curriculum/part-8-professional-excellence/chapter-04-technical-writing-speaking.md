...
```mermaid
flowchart TD
    subgraph WRITING [Technical writing]
        DESIGNDOC[Design doc — 1.5<br/>changes decisions]
        ARTICLE[Article<br/>builds the voice]
    end
    subgraph SPEAKING [Public speaking]
        TALK[Talk<br/>changes decisions, builds reputation]
    end
    DISCIPLINE[The communication discipline — 1.5<br/>SCQA, audience, clarity] -.extends to.-> WRITING & SPEAKING
    WRITING & SPEAKING --> PRESENCE[The public presence<br/>the voice, the reputation]
    PRESENCE -.the reputation asset.-> MARKET[The market — 8.1<br/>known, trusted, influential]
```
